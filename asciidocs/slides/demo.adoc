...
* an einen Server senden oder veröffentlichen
* Der Broker überträgt die Informationen dann an diejenigen Clients, die das Topic des Clients zuvor abonniert haben.
* Alle 5 Minuten Json-Files von Devices der Schule
